...
class BaseFixVenueClientRBC(MFFixVenueClient):
    ...
    def __init__(self, args):
        if not hasattr(self, 'name'): # Derived may set it up
            self.name = "Base Fix Client RBC" # Must be before super
        super(BaseFixVenueClientRBC, self).__init__(args)
